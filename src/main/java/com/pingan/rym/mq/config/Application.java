package com.pingan.rym.mq.config;
...
public class Application {
    ...
    @Bean("liuXinWuQueue")
    public Queue liuXinWuQueue(){
        return new Queue("liuXinWuQueue");
    }
...
//    @Bean
//    Binding bindingExchange(@Qualifier("helloQueue")Queue helloQueue, TopicExchange exchange) {
//        return BindingBuilder.bind(helloQueue).to(exchange).with("helloQueue");
//    }
